...
public class PolizaAprobada  implements java.io.Serializable {
    ...
    @EmbeddedId
    @Column(name="CLIENTES_id", nullable=false, length=45)
    ...
    @JoinColumns({
        ...
        @JoinColumn(name="CLIENTES_tipo_id", referencedColumnName="tipo_id", insertable = false, updatable = false)
    })
    ...
    @ManyToOne(cascade = CascadeType.ALL)
    @JoinColumn(name="POLIZAS_codigo_poliza", referencedColumnName="codigo_poliza", insertable = false, updatable = false)
